...
%   www.palamedestoolbox.understandingfitting.html or Prins (2019;
%   AP&P, https://doi.org/10.3758/s13414-019-01706-7 for more information). 
...
%   which case the reported parameter estimates will be inaccurate. In 
%   other words, users are strongly discouraged from changing the default. 
%   A better solution is to either get more data or fit a simpler model. 
%   Another option is to use a Bayesian fitting approach 
%   (PAL_PFHB_fitModel.m will fit one or multiple PFs using a Bayesian 
%   criterion).
%
%Full example:
%
...
%   1.8.1, 1.9.0, 1.9.1, 1.10.9 (see History.m)
